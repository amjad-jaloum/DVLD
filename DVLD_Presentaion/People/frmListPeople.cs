...
namespace _19___Project___DVLD.People
{
    public partial class frmListPeople : Form
    {
        ...
        private void mtxbSearch_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                dgvPeople.DataSource = clsPerson.GetFilterdPeopleDataTable(cbFilter.SelectedItem.ToString(), mtxbSearch.Text);
                lblRowsCountValue.Text = dgvPeople.RowCount.ToString();
            }
        }
        ...
        private void showDetailsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            frmShowPersonInfo showDetails = new frmShowPersonInfo(person);
