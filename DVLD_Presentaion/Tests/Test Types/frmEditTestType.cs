...
namespace _19___Project___DVLD.Test_Types
{
    public partial class frmEditTestType : Form
    {
        ...
        {
            clsTestType test = new clsTestType(Convert.ToInt32(lblTestID.Text), tbTestTitle.Text, tbTestDesc.Text, (float)Convert.ToDouble(tbTestFees.Text));
            return clsTestType.UpdateTestType(test);
        }
