...
namespace _19___Project___DVLD.Driving_Licenses.International_Licenses
{
    public partial class ctrlShowDriverLicenseAndInternationalApplicationInfoWithFilter : UserControl
    {
        ...
        {
            return ctrlShowLicenseInfo1.license.LicenseClass == (int)LicenseClass.LicenseType.Class_3_Ordinarydrivinglicense;
        }
        ...
        private void loadInternationalLicenseInfo(int IssuedUsingLocalLicenseID)
        {
            ...
            Application Application = Application.Find(InternationalApplication.ApplicationID);
            if(Application == null)
            {
        ...
        {
            return InternationalDrivingLicensesApplication.IsInternationalLicenseExists(Convert.ToInt32(tbSearch.Text));
        }

        private int AddNewInternationalLicense()
        {
            int LicenseID = Convert.ToInt32(tbSearch.Text);
            AppLicense appLicense = AppLicense.FindLicense(LicenseID);
            InternationalDrivingLicensesApplication internationalLicense = new InternationalDrivingLicensesApplication(
                0,
