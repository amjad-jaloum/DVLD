...
namespace _19___Project___DVLD.Drivers
{
    public partial class frmManageDrivers : Form
    {
        ...
        {
            List<string> ColumnNames = Driver.GetDriversColumnNames();
            if (ColumnNames == null)
            {
        ...
        {
            dgvDrivers.DataSource = Driver.GetDriversData();
        ...
        private void UpdateDataTableWithFilter()
        {
            if (!cbFilter.SelectedItem.ToString().Contains("None"))
            {
                ...
                dgvDrivers.DataSource = Driver.GetDataTableWithQuery(cbFilter.SelectedItem.ToString(), SearchValue);
