...
namespace _19___Project___DVLD.Driving_License_Services.Schedule_Tests
{
    public partial class frmTakeTest : Form
    {
        ...
        {
            if (AddNewTestResult(_TestAppointmentID, TestResult(), tbTestNotes.Text, clsGloabalSettings.LogginUser.UserID))
            {
        ...
        {
            return (LocalDrivingLicenseApplication.AddNewTestResult(testAppointmentID, result, notes, userID)
                && LocalDrivingLicenseApplication.LockTestAppointment(testAppointmentID));
        }
