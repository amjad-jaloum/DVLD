...
namespace _19___Project___DVLD.Driving_License_Services
{
    public partial class frmShowDrivingLicenseApp : Form
    {
        ...
        public frmShowDrivingLicenseApp(int LocalDrivingLicenseAppID, string licenseName, string applicantFullName, DateTime appDate, short passedTests, string appStatus)
        {
            InitializeComponent();
